    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto">
            <h2 class="text-2xl font-bold mb-6 flex items-center text-gray-800">
                <i class="ri-add-box-line mr-2 text-blue-500"></i> Item Information
            </h2>
            ...
            <form method="POST" class="space-y-5">
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                    <button type="reset" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 flex items-center">
                    ...
                    <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center">
                        <i class="ri-save-line mr-1"></i> Save Item
                    </button>
                </div>
            </form>
        </div>
